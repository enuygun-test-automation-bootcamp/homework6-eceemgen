...
public class HomePage {
    ...
    public void setPurchaseListTitle() {
        JavascriptExecutor jse = (JavascriptExecutor)driver;
        jse.executeScript("window.scrollBy(0,-250)");
        this.elementHelper.findElement(purchase).click();
        Assert.assertEquals(expextedpurchase,this.elementHelper.findElement(titleOfPurchase).getText());
    }
}
